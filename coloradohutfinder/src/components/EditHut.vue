...
export default {
  ...
  methods: {
    ...
    this.WINTER_Water_Cistern_non_potable= this.hut
      .WINTER_Water_Cistern_non_potable
    this.WINTER_Water_Running_water_potable= this.hut
      .WINTER_Water_Running_water_potable
    this.WINTER_Water_Spring_stream_lake_non_potable= this.hut
      .WINTER_Water_Spring_stream_lake_non_potable
    this.Suggested_SUMMER_Vehicle_Access= this.hut
      .Suggested_SUMMER_Vehicle_Access
    this.SUMMER_Parking_Available_On_site= this.hut
    ...
    this.SUMMER_Water_Cistern_not_potable_on_site= this.hut
      .SUMMER_Water_Cistern_not_potable_on_site
    this.SUMMER_Water_Running_potable_on_site= this.hut
      .SUMMER_Water_Cistern_not_potable_on_site
    this.SUMMER_Water_None_bring_your_own_water= this.hut
      .SUMMER_Water_None_bring_your_own_water
    this.SUMMER_Water_less_than_one_quarter_mi_to_Spring_stream_lake_non_potable= this.hut
      .SUMMER_Water_less_than_one_quarter_mi_to_Spring_stream_lake_non_potable
    this.SUMMER_Water_greater_than_one_quarter_mi_to_Spring_stream_lake_non_potable= this.hut
      .SUMMER_Water_greater_than_one_quarter_mi_to_Spring_stream_lake_non_potable
    this.FOOD_Guests_bring_prepare_their_own= this.hut
      .FOOD_Guests_bring_prepare_their_own
    this.REFRIGERATION= this.hut.REFRIGERATION
    this.DISHES_POTS_PANS_UTENSILS_CLEANING_SUPPLIES= this.hut
      .DISHES_POTS_PANS_UTENSILS_CLEANING_SUPPLIES
    this.BURNERS= this.hut.BURNERS
    this.OVEN= this.hut.OVEN
    this.GRILL= this.hut.GRILL
    this.GUESTS_MAY_BRING_OWN_GRILL_Restrictions_may_apply= this.hut
    ...
    this.OUTHOUSE_No_covered_walkway_walk_a_short_distance= this.hut
    ...
    this.GUESTS_CLEAN_HUT_OR_YURT_BEFORE_DEPARTURE= this.hut
      .GUESTS_CLEAN_HUT_OR_YURT_BEFORE_DEPARTURE
    this.GUESTS_CARRY_OUT_THEIR_TRASH_Trashbags_provided= this.hut
      .GUESTS_CARRY_OUT_THEIR_TRASH_Trashbags_provided
    this.LIGHTING= this.hut.LIGHTING
    this.SAUNA= this.hut.SAUNA
    this.ELECTRICAL_OUTLETS_FOR_GUEST_USE= this.hut
