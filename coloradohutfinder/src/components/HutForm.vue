...
<script>
// import post from '../lib/crudformfunctions'
export default {
  name: 'HutForm',
  data: () => ({
  ...
  methods: {
    ...
    toggleBookings() {
      if(this.Single_Party_Bookings_Only === false) {
        this.Multiple_Groups_Can_Book === true
      } else if (this.Single_Party_Bookings_Only === true) {
        this.Multiple_Groups_Can_Book === false
      }
    }
  }
};
